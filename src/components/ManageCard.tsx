    ...
    <div className="flex flex-row w-full h-full bg-[#17191C]  rounded-lg shadow-lg relative">
      <div className="absolute text-xl right-0 top-0 flex flex-row space-x-3 px-10 py-5">
        <button
          ...
          className="py-1 px-5 bg-gradient-to-r from-[#F05B80] to-[#4158F0] text-white rounded-lg"
        >
          {isEditing ? "Cancel" : "Edit"}
        </button>
        <button className="py-1 px-5 bg-rose-600 text-white rounded-lg">
          Delete
        </button>
      </div>
      <div className="w-[30%] h-full bg-red-100 relative rounded-lg">
        <Image
          ...
          fill={true}
          alt="car"
          onClick={() => router.push(`/reserve/${id}`)}
